...
function showTopLevelHelp(): void {
  ...
  console.log('  app             Manage OGP Apps');
  console.log('  tunnel          Manage public tunnel reachability');
  console.log('  config          Manage framework configuration');
  console.log('  keychain        Manage dedicated macOS keychain storage');
  console.log('  completion      Manage shell completion');
  ...
  console.log('');
  console.log('Deprecated aliases:');
  console.log('  expose          Use: ogp tunnel start');
  console.log('  expose-stop     Use: ogp tunnel stop');
  console.log('');
