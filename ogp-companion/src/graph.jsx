  ...
  return (
    <svg viewBox={`0 0 ${W} ${H}`} style={{ width: "100%", height: "100%", display: "block" }} preserveAspectRatio="xMidYMid meet">
      ...
      <g>
        ...
        {/* white ring on transparent bg, sits on the ocean-accent core (g-core).
            Uses the .svg (not the black-bg .png) so no dark square shows. */}
        <image href="assets/ogp-symbol-white.svg"
          x={cx - 20} y={cy - 20} width="40" height="40" opacity="0.96" />
